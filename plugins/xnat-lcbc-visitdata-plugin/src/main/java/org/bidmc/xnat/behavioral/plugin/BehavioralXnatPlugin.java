...
@XnatPlugin(name="LCBC Visitdata", value="BehavioralPlugin", description="Extend XNAT for behavioral data",  entityPackages = "org.bidmc.xnat.behavioral.subjectmapping",  
